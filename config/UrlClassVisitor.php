...
class URLShortener{
    ...
    function validate(){
        ...
        if(!empty($long_url)){
            ...
            if($insertData){
                return '
                <p class="text-danger">ini adalah hasilnya, silahkan copy url tersebut, 2detik akan automatis reload <div class="input-group mb-3">
            ...
            return '<p style="text-align:center;">Kolom belum diisi.</p>';
        }
