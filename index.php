       ...
       <!-- Ini adalah Bagian Header Modal -->
        <div class="modal-content">
            ...
            <div class="modal-body">
             Selamat datang di website <strong>ZepeLink</strong><br>
             <strong>ZepeLink</strong>  adalah sebuah layanan yang biasa digunakan oleh orang-orang  
            ...
            saat ini website  <strong>ZepeLink</strong> masih menjalanin beta tester untuk pertama kalinya
            <br><br>Bantu Kami untuk mencari bugs, jika anda menemukan bugs pada website kami harap laporkan ke halaman ini : <br>
            <a href="https://ig.me/m/yunse.zpt" target="_blank">Lapor Sekarang</a>
    ...
    <nav class="navbar navbar-expand-md navbar-light fixed-top bg-light d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
            <div class="container">
                ...
                <a class="navbar-brand" href="beranda">
                    <span class="title">ZepeLink</span>
                </a>
        ...
        <div class="content-header row">
            <div class="col-md-12">
                <div class="alert alert-info" role="alert">
                    <i class="fas fa-info-circle title-icon"></i> Selamat Datang di <strong>ZepeLink</strong>.
                </div>
            </div>
        </div>
